(function ($) {
    ...
    var Blessed_Template    =   {
        ...
        // Donation panel
        donation_panel: function (params) {
            var donationCloseIcon = $('.donation-panel-item .close-icon');

            donationCloseIcon.on('click', function (e) {
                // e.stopPropagation();
                e.preventDefault();
                $(this).closest('.donation-panel-item').hide();
            });
        },

        // Memorial notes
        memorial_notes: function (params) {
            var memorialNotesBtn = $('.memorial-notes .add-btn');

            memorialNotesBtn.on('click', function (e) {
                $('.memorial-notes ol').append('<li><input type="text" name="memorial_names[]"></li>');
            });
        },
